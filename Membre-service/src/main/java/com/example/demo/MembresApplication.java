...
public class MembresApplication implements CommandLineRunner {
	...
	public void run(String... args) throws ParseException {
		...
		Membre etud1 = new Etudiant("11100494", "Boudabous", "wiem", date1, "cv1.pdf", "wiem@gmail.com", "sss55", 111);

		Membre etud2 = new Etudiant("12683599", "Sehli", "salsabil", date2, "cv2.pdf", "salsa@gmail.com", "pp!!3", 222);
		memberRepository.save(etud1);
		memberRepository.save(etud2);

		Membre ens1 = new EnseignantChercheur("11111552", "salah", "ahmed", date3, "cv3.pdf", "s@gmail", "sss55", 333);
		Membre ens2 = new EnseignantChercheur("33658954", "Hedi", "mounir", date4, "cv3.pdf", "h@gmail", "sss55", 444);
